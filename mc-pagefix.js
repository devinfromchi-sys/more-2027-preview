...
(function(){
  ...
  function apply(){
    ...
    injectCSS('mc-signup-css','#footer-sections .newsletter-form-header-title{color:#9B1762!important;-webkit-text-fill-color:#9B1762!important}#footer-sections .newsletter-form-header-subtitle,#footer-sections .newsletter-form-body,#footer-sections .newsletter-form-field-element,#footer-sections .newsletter-form-field-element::placeholder{color:#33302b!important;-webkit-text-fill-color:#33302b!important}#mc-signup{scroll-margin-top:90px}');
